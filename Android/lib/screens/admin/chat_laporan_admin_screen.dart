...
class ChatLaporanAdminScreen extends StatefulWidget {
  final int laporanId;
  final String judulLaporan;
  final String? namaUser;

  const ChatLaporanAdminScreen({
    super.key,
  ...
  @override
  State<ChatLaporanAdminScreen> createState() => _ChatLaporanAdminScreenState();
}

class _ChatLaporanAdminScreenState extends State<ChatLaporanAdminScreen> {
      ...
      if (mounted) {
        ...
        if (silent &&
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Pesan baru dari masyarakat'),
